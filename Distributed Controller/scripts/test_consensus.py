#!/usr/bin/env python3
"""
Test the consensus distributed algorithm.

Sets all desks to occupied with equal costs, enables consensus mode,
...
CSV_FILE = os.path.join(SCRIPT_DIR, "consensus_results.csv")
...
def main():
    parser = argparse.ArgumentParser(description="Test consensus algorithm")
    ...
    all_results = []  # rows for CSV: (node, ref, mean_lux, max_error, pass)
    all_stream_data = {}  # node_id -> [(value, time_ms), ...]
    all_ok = True
